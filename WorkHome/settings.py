...
ISHOME = False
HOST_HOME = '192.168.1.9'
HOST_COMP = '192.168.46.129'
REDIS_CACHES_HOME = "redis://%s/9" % HOST_HOME
...
SECRET_KEY = 'jskd(=!d6e65t9a@=4r_!2g4qg&81!qewhl_vwk(jo#ix+aby&'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': '987123',
        'HOST': HOST_HOME if ISHOME else HOST_COMP,
        'PORT': 3306
    }
}
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = 'hikingcool@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = '987123hiking'
# 收件人看到的发件人
EMAIL_FROM = '天天生鲜<hikingcool@163.com>'

# Django的缓存配置
CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": REDIS_CACHES_HOME if ISHOME else REDIS_CACHES_COMP,
        "OPTIONS": {
